(() => {
  ...
  const ptToEn = {
    ...
    ,'Conexão AWS': 'AWS connection', 'Selecione uma conexão AWS': 'Select an AWS connection', 'Atualize e selecione um Secret': 'Refresh and select a Secret', 'Pré-check': 'Pre-check', 'Arquivada': 'Archived', 'Bucket de controle': 'Control bucket', 'Conta AWS': 'AWS account'
  };
  const phraseToEn = {

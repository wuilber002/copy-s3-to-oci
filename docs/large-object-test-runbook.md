...
8. Exporte o relatório consolidado da source e confirme que a wave registra a duração prevista e a duração observada da cópia. Isso valida o insumo que o planejador dinâmico reutiliza em waves futuras.
...
- A interrupção pode repetir no máximo a parte que ainda não foi confirmada pelo OCI; as partes persistidas no checkpoint não são reenviadas.

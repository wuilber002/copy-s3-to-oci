...
- O Painel mostra duas métricas de transferência: taxa em andamento, persistida pelos workers a cada até dois segundos para arquivos ainda em cópia, e throughput concluído em uma janela de até cinco minutos, calculada a partir da primeira conclusão observada. Restores disponíveis consideram somente classes arquivadas e são apresentados em arquivos/minuto e arquivos/hora.

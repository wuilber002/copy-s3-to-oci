...
- SHA-256 é calculado durante a leitura do S3. Para objetos pequenos, o valor é enviado ao `PutObject` e validado pelo OCI antes da aceitação. Para objetos grandes, cada parte de 64 MiB recebe SHA-256 próprio e o OCI valida todas as partes do multipart antes do commit. A evidência nativa de entrega fica no PostgreSQL sem reler o destino.

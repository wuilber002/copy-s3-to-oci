...
- O Painel mostra duas métricas de transferência: taxa atual de 15 segundos, combinando amostras de arquivos em cópia e conclusões recentes para também representar arquivos pequenos, e throughput concluído em uma janela de até cinco minutos, calculada a partir da primeira conclusão observada. Restores disponíveis consideram somente classes arquivadas e são apresentados em arquivos/minuto e arquivos/hora.

...
- O Painel mostra duas métricas de transferência: taxa em andamento, persistida pelos workers a cada até dois segundos para arquivos ainda em cópia, e throughput concluído na janela móvel de cinco minutos. Restores disponíveis são apresentados em arquivos/minuto e arquivos/hora.
